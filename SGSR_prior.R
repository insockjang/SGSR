SGSR_prior_CCLE<-function(pathwayName,dataCombine,KK = c(1:24),mcCoreNum = 32){
  ...
  for(kk in KK){
    filename = paste("~/Result_priorIncorporateLassoNew_filterVar02/",dataCombine,"/CCLE/",pathwayName,"/PriorIncorporated_cvDrug_",kk,".Rdata",sep = "")
...
SGSR_prior_Sanger<-function(pathwayName,dataCombine,KK = c(1:138),mcCoreNum = 32){
  ### DEMO Stepwise grouping Lasso
  require(predictiveModeling)
  require(synapseClient)
  require(devtools)
