PriorRandomLasso_Sanger<-function(pathwayName,dataCombine,KK = NA,mcCoreNum = 32){
  ...
  for(kk in KK){
    filename = paste("~/Result_priorIncorporateLassoNew_filterVar02/",dataCombine,"/Sanger/",pathwayName,"/restoredRandom_cvDrug_",kk,".Rdata",sep = "")
