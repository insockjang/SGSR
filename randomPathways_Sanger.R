randomPathway_Sanger<-function(pathwayName,dataCombine){
  ...
  for(kk in 1:138){  
    filename = paste("~/Result_priorIncorporateLasso_filterVar02/",dataCombine,"/Sanger/",pathwayName,"/PriorRandomPathwayStructure_cvDrug_",kk,".Rdata",sep = "")
